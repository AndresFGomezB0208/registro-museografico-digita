...
export default function MuseoDelMarPage() {
    const pieces = getPiecesByMuseum("Museo del Mar");
        ...
        <div className="min-h-screen bg-[#050505]">
            ...
            <section className="relative pt-32 pb-20 px-6 overflow-hidden">
                <div
                    ...
                    style={{
                        background:
                            "radial-gradient(ellipse 70% 40% at 50% 0%, rgba(14,58,83,0.12) 0%, transparent 70%)",
                    }}
                />
                <div className="max-w-6xl mx-auto relative z-10">
                    ...
                    >
                        ...
                        <p className="font-body text-[#A0A0A0] text-lg max-w-2xl leading-relaxed mb-8">
                            Archivo paleontológico de los océanos cretácicos colombianos. Fósiles, huesos, animatrónicos y reconstrucciones del ecosistema marino de hace 75 millones de años.
                        </p>

                        <div className="flex flex-wrap gap-3">
                            {["Fósiles", "Huesos", "Reconstrucciones", "Animatrónicos", "Fauna extinta"].map((tag) => (
                                <span
                                    key={tag}
                                    className="px-3 py-1.5 bg-[#111111] border border-[#0E3A53]/30 rounded font-mono text-[9px] tracking-widest text-[#5BA3C9] uppercase"
                                >
                                    {tag}
                                </span>
                            ))}
